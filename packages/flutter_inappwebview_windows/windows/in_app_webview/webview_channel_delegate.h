...
namespace flutter_inappwebview_plugin
{
  ...
  public:
    ...
    // PAHE CAT PATCH: upstream Windows has no sender for this event, so the
    // "onDownloadStartRequest" case the Dart side of this plugin already
    // handles was unreachable. See in_app_webview.cpp.
    void onDownloadStartRequest(const std::string& url,
